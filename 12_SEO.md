...
Последняя сверка: 2026-08-05 (полная) · 2026-08-10 (точечная: HVAC-калькулятор) · 2026-08-13 (точечная: Bing WMT + IndexNow) · 2026-08-27 (точечная: NV practice-страницы) · 2026-09-17 (точечная: +6 practice-страниц, allowlist `EXAMS` в `js/seo.js`) · 2026-09-20 (точечная: лендинг — пикер, каталог по штатам)
