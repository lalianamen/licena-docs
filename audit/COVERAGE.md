...
| SMM | `docs/smm/*` | 03 (перечень; `docs/smm/video/` — промо-видео, состав файлов), 26 (строка 2026-09-09: сцены и источник каждой строки видео), 28 (механика очередей, где лежит видео) | частично | → `23_SMM_STATE.md`; промо-видео живёт в ветке `claude/lasena-video-creation-bgxgc9`, не в `main` |
