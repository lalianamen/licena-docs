...
Последняя сверка: 2026-08-05 · дополнение 2026-08-10 (см. примечание после таблицы) · 2026-08-30 (точечная: маркетинговые агрегаты) · 2026-09-10 (точечная: видео smm)
...
| SMM | `docs/smm/*` | 03 (перечень, папка `video/`), 26 (строка 2026-09-10), 28 (механика очередей, видео-генератор) | частично | → `23_SMM_STATE.md` (паки, календарь, каналы) |
