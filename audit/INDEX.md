...
| `14_ANALYTICS.md` | заполнен | 2026-09-11 | Verified (по коду; часть живых данных подтверждена выгрузками владельца, первый запуск cron — UNKNOWN) |
| `15_METRICS.md` | заполнен | 2026-09-16 | Partially Verified |
...
| `26_CHANGELOG.md` | заполнен | 2026-09-16 | Partially Verified |
| `27_ROADMAP.md` | не создан | — | — |
| `28_AI_CONTEXT.md` | заполнен | 2026-09-16 | Partially Verified |
...
| `tasks/` | создана (протокол Owner → Claude (ревью ChatGPT убрано 2026-09-11, ADR-002): `WORKFLOW.md`, карточки задач, `reviews/`, `reports/`) | 2026-09-11 | Verified (журнал рабочего процесса; факты по живой БД — из выгрузок Supabase Dashboard, предоставленных владельцем) |
| `audit/FILES.md` | создан 2026-09-11 (состав базы знаний, вынесен из `CLAUDE.md` §4) | 2026-09-11 | Verified (перенос дословный) |
| `audit/DOC-STANDARD.md` | создан 2026-09-11 (стандарт документа, вынесен из `CLAUDE.md` §5 и §9) | 2026-09-11 | Verified (перенос дословный) |
| `decisions/ADR-002-…` | создан 2026-09-11 (ревью ChatGPT убрано, инструкции разбиты) | 2026-09-11 | Verified (решение владельца в сессии) |
