...
| `rfc/2026-08-19-lifecycle-notifications.md` | создан (статус: Proposed; Phase 1 РЕАЛИЗОВАНА на ветке — 5 коммитов по a8fe749; в main/Supabase после одобрения) | 2026-08-19 | Partially Verified (аудит §1 — Verified; §2–10 — предложение) |
