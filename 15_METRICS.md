...
| Банк на ветке, не влитый в `main`/`content-banks-src` | `az-b` — 500 EN + 500 RU + 500 ES (1 500 позиций), ветка `claude/az-b-general-contractor-9zj4e9`, завершён 2026-08-16; в числа выше НЕ входит |
