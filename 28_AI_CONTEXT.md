...
(ветка осн. репо); на ветке `content-banks-src` готов ВЕСЬ EN-банк —
5 блоков × 100 (500 вопросов, ids 1–500, ключи ровно A125 B125 C125 D125,
`0b72f6c`) и RU/ES-оверлеи блоков 1–4 (`367bb00`); осталось: переводы
Блока 5, финальный проход (10% выборочная перепроверка ключей,
семантик-свип) и wiring (EXAM_FORMATS + CSV-импорт в Supabase). Примечание к цифрам
