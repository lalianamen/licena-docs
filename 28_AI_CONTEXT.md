...
- (дополнение 2026-08-10) HVAC-калькулятор: публичные страницы
  ...
  `claude/hvac-materials-calculator-gfzkwl` (`632d190`, `32f7201`);
  влито в `main` 2026-08-10 (fast-forward `ed30701`→`32f7201`) по запросу владельца. ВАЖНО: страницы `/tools/` не
