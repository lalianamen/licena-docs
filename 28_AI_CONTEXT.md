...
Осталось за владельцем: перевыполнить `supabase/sql/trial-3day.sql` и
`supabase/sql/stripe-payments.sql` в Supabase, передеплоить `stripe-checkout`,
смержить ветку в `main`. Practice-страницы
