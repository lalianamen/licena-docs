...
(ветка осн. репо); на ветке `content-banks-src` готовы Блок 1 + Блок 2
(200 EN-вопросов, ids 1–200) и RU/ES-оверлеи Блока 1 (`1ab639f`);
осталось: блоки 3–5, переводы блоков 2–5, финальный проход и wiring
(EXAM_FORMATS/каталог). Примечание к цифрам
