...
`meta-sync` + `social_snapshots` + блок «Соцсети» в письме — `main` @ `47f2a2f` (выложено,
в Supabase не развёрнуто), ждёт Page-токена владельца (`META_PAGE_TOKEN`), SQL, деплоя и cron; TikTok — вручную; договорённости: одна таблица
