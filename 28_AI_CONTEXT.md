...
25.03.2026). Генерация платных NV-банков НАЧАТА 2026-08-25: `nv-cms` —
блюпринт и fact ledger в `docs/content/nv-cms-blueprint.md`/`nv-cms-ledger.md`
(ветка осн. репо), Блок 1 = 100 EN-вопросов на ветке `content-banks-src`
(`89145b1`); блоки 2–5 и переводы RU/ES — следующие runs. Примечание к цифрам
