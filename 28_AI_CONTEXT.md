...
написан следом (банк до `1fc8713`, леджер до `fd0970f`, ключи 25/25/25/25). Дальше по очереди: Блоки 3, 4, 5, 1 → RU/ES-оверлеи → финальная
