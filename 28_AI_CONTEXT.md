...
- Видео для TikTok/IG Reels («вопрос дня», 30 с, 1080×1920, EN/ES/RU, без
  звука): генератор `docs/smm/video/c20-fall-protection/` — `index.html`
  (анимация, строки в блоке `T`, `?lang=`, `?play=1` для просмотра) +
  `render.js` (Playwright + ffmpeg → `out/*.mp4`, `out/cover-*.png`); пак с
  fact-trace — `docs/smm/pack-2026-09-10-video-c20-fall-protection.md`.
  Ветка `claude/lasena-30sec-video-rkeqq6` (статус мержа в `main` — по git).
