...
- `CLAUDE.md` licena-docs (этого репо): двойная роль Claude — разработка
  ...
  append-only журналы, стандарт аудита (`audit/DOC-STANDARD.md`); бизнес-оценки — только ChatGPT
  (`30_CTO_REPORT.md`).
...
| Бизнес-аудит, оценки, `30_CTO_REPORT.md` | ChatGPT | `CLAUDE.md` licena-docs §1 |
